...
const routes = [
    ...
    {
        path: 'match',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_match_match_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./match/match.module */ 8686)).then((m) => m.MatchPageModule),
    },
    {
        path: 'login',
    ...
    {
        path: 'adoption',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_adoption_adoption_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./adoption/adoption.module */ 5207)).then(m => m.AdoptionPageModule)
    },
    {
        path: 'signup',
    ...
    {
        path: 'forgetpass',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_forgetpass_forgetpass_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./forgetpass/forgetpass.module */ 8871)).then(m => m.ForgetpassPageModule)
    },
    {
        path: 'profile',
...
let AppComponent = class AppComponent {
    constructor() {
        this.appPages = [{ title: 'Anasayfa', url: '/folder', icon: 'mail' }];
    }
};
